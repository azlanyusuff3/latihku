const SHELL_CACHE='latihku-shell-v2.0.0';
const DATA_CACHE='latihku-data-v2.0.0';
const SHELL=['./','index.html','styles.css','config.js','engine.js','app.js','manifest.json','icons/icon-192.png','icons/icon-512.png'];
