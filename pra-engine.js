window.LATIH_PRA = (() => {
  const activities = [
    ...
    {id:'draw',icon:'✍️',name:'Lukis',desc:'Ikut garisan huruf & bentuk',kind:'draw',accent:'orange'},
    {id:'color',icon:'🎨',name:'Mewarna',desc:'Pilih warna dan warnakan gambar',kind:'color',accent:'pink'},
